...
const winZips = files.filter((f) => f.endsWith('.zip') && f.includes('-win-') && f.startsWith('Nikon.UVC-PTP.Bridge'))
...
for (const name of winZips.sort()) {
  ...
  installers.push({
    ...
    NestedInstallerFiles: [{ RelativeFilePath: 'Nikon UVC-PTP Bridge.exe' }]
  })
}
...
if (installers.length === 0) {
  ...
  const packageId = 'AMDphreak.NikonUvcPtpBridge'
...
PackageName: Nikon UVC-PTP Bridge
